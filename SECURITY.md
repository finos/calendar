...
If you find something you believe to be a security issue, we encourage and appreciate your report. Please report the issue privately to the [project maintainers](https://github.com/finos/calendar/blob/main/MAINTAINERS.md) using one of the following methods:

## Reporting a Vulnerability

- **GitHub Security Reports:** In order for the vulnerability reports to reach maintainers as soon as possible, the preferred way is to use the ["Report a vulnerability"](https://github.com/finos/calendar/security) button under our "Security and quality" tab. This creates a private communication channel between you and the maintainers.
