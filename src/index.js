        ...
        eventDidMount: function (info) {
            ...
            tippy(info.el, {
                ...
                onShow(instance) {
                    ...
                    const startTime = moment(info.event.start).tz('America/New_York').format('MMMM DD hh:mm a');
                    const endTime = moment(info.event.end).tz('America/New_York').format('MMMM DD hh:mm a');
