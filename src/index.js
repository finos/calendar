        ...
        eventDidMount: function (info) {
            ...
            tippy(info.el, {
                ...
                onShow(instance) {
                    ...
                    modalContent.innerHTML = `<b>${info.event.title}</b><br></br>Start: ${info.event.start.toLocaleString()} EST<br></br>End: ${info.event.end.toLocaleString()} EST<br><br>${info.event.extendedProps.description}<br>`;
